...
# gdb-7.7 misses to canonicalize man-pages
  mv ${RPM_BUILD_ROOT}%{_mandir}/man1/gdb.1 ${RPM_BUILD_ROOT}%{_mandir}/man1/powerpc-rtems4.10-gdb.1
  mv ${RPM_BUILD_ROOT}%{_mandir}/man1/gdbserver.1 ${RPM_BUILD_ROOT}%{_mandir}/man1/powerpc-rtems4.10-gdbserver.1
  mv ${RPM_BUILD_ROOT}%{_mandir}/man5/gdbinit.5 ${RPM_BUILD_ROOT}%{_mandir}/man5/powerpc-rtems4.10-gdbinit.5

# not useful for us.
  rm -f ${RPM_BUILD_ROOT}%{_datadir}/powerpc-rtems4.10-gdb-%{gdb_version}/system-gdbinit/{wrs-linux,elinos}.*
  rmdir ${RPM_BUILD_ROOT}%{_datadir}/powerpc-rtems4.10-gdb-%{gdb_version}/system-gdbinit
%endif
...
%if "%{gdb_version}" >= "7.7"
%dir %{_mandir}/man5
%{_mandir}/man5/powerpc-rtems4.10-*.5*
%endif
